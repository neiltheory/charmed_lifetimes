...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   factory->AddVariable( "pplus_P", 'F' );
   factory->AddVariable( "pplus_PT", 'F' );
   factory->AddVariable( "piplus_P", 'F' );
   factory->AddVariable( "piplus_PT", 'F' );
   factory->AddVariable( "Kminus_PIDK", 'F' );
   ...
   */
   ...
   factory->AddSpectator( "Lambda_cplus_M := Lambda_cplus_M",  "Lc Mass", "GeV", 'F' );
   factory->AddSpectator( "Lambda_cplus_TAU := Lambda_cplus_TAU",  "Lc lifetime", "s", 'F' );
   factory->AddSpectator( "Lambda_cplus_IPCHI2_OWNPV := Lambda_cplus_IPCHI2_OWNPV",  "Lc IPCHI2", "units", 'F' );
